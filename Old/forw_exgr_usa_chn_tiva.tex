% Created by tikzDevice version 0.9 on 2016-01-08 18:24:05
...
\path[fill=fillColor] ( 99.85, 14.54) rectangle (437.79, 37.53);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (107.73, 18.80) rectangle (122.19, 33.26);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{fillColor}{RGB}{241,89,95}

\path[fill=fillColor] (108.44, 19.52) rectangle (121.48, 32.55);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{gray}{0.80}
...
\path[draw=drawColor,line width= 0.6pt,line join=round,line cap=round,fill=fillColor] (291.89, 18.80) rectangle (306.34, 33.26);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{fillColor}{RGB}{249,166,90}

\path[fill=fillColor] (292.60, 19.52) rectangle (305.63, 32.55);
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{gray}{0.80}
...
\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (123.99, 22.72) {Forw. VAX China};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (218.74, 22.72) {Forw. VAX USA};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (308.15, 22.72) {EXGR China};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  0.96] at (382.53, 22.72) {EXGR USA};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (505.89,505.89);
\definecolor{drawColor}{RGB}{0,0,0}

\node[text=drawColor,anchor=base west,inner sep=0pt, outer sep=0pt, scale=  1.2] at ( 47.90,489.97) {RCA based on Forw. VAX and EXGR for CHN and USA};
\end{scope}
\end{tikzpicture}
